...
module.exports = class Transaction {
    static create = async (params = {category_id,user_id,compte_id,toaccount, montant,commentaire,type,date}, urlb={token, Cookie}) => {
    ...
    static read = async (params = {user_id, compte_id, category_id, id}, urlb={token, Cookie}) => {
        let base = {'X-Requested-With': 'XMLHttpRequest'}
        let auth = {...base, ...urlb}
    ...
    static update = async (params={icon, name:"", id}, urlb={token, Cookie}) => {
        let base = {'X-Requested-With': 'XMLHttpRequest'}
        let auth = {...base, ...urlb}
    ...
    static destroy = async(params={id, user_id}, urlb={token, Cookie}) =>{
        let base = {'X-Requested-With': 'XMLHttpRequest'}
        let auth = {...base, ...urlb}
