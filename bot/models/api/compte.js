...
module.exports = class Compte {
    static create = async (params = {montant, type}, urlb={token, Cookie}) => {
    ...
    static read = async (params = {user_id, id}, urlb={token, Cookie}) => {
        let base = {'X-Requested-With': 'XMLHttpRequest'}
        let auth = {...base, ...urlb}
    ...
    static update = async (params={montant, id}, urlb={token, Cookie}) => {
        let base = {'X-Requested-With': 'XMLHttpRequest'}
        let auth = {...base, ...urlb}
